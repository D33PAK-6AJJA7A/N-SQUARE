...
public class ScoreBoard extends JPanel {		// Its is of panel type
    ...
    ScoreBoard(JFrame frame) {		// everything is added to list 
        this.frame = frame;
        list3 = new ArrayList<>();
        list3.add(new PlayerData("Krishna", 14,"E"));
        list3.add(new PlayerData("Deepak", 52,"M"));
        list3.add(new PlayerData("Divyatez", 10,"M"));
        list3.add(new PlayerData("Divyatez", 38,"H"));
        list3.add(new PlayerData("Akshat", 16,"H"));
        list3.add(new PlayerData("Krishna", 32,"H"));
        ...
        list4.add(new PlayerData("Akshat", 16,"H"));
        list4.add(new PlayerData("Krishna", 32,"H"));
        list4.add(new PlayerData("Divyatez", 34,"E"));
        list4.add(new PlayerData("Akshat", 21,"M"));
        list4.add(new PlayerData("Deepak", 20,"H"));
        
        
        ////////////////
        list5 = new ArrayList<>();
        
        list5.add(new PlayerData("Divyatez", 38,"H"));
        list5.add(new PlayerData("Akshat", 16,"H"));
        list5.add(new PlayerData("Krishna", 32,"H"));
        list5.add(new PlayerData("Divyansh", 34,"E"));
